...
public class CustomColorPickerSquare extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public CustomColorPickerSquare(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public CustomColorPickerSquare(Context context, AttributeSet attrs, int defStyle) {
