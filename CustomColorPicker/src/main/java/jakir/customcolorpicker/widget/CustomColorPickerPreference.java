package jakir.customcolorpicker.widget;
...
import jakir.customcolorpicker.R;

public class CustomColorPickerPreference extends Preference {
    private final boolean supportsAlpha;
    int value;

    public CustomColorPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setWidgetLayoutResource(R.layout.customcolorpicker_pref_widget);
    }
    ...
    protected void onClick() {
        new CustomColorPickerDialog(getContext(), "Select a color", value, supportsAlpha, new CustomColorPickerDialog.OnCustomColorPickerListener() {
            @Override
